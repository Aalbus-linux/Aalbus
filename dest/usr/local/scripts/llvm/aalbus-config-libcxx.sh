...
cmake -DLLVM_ENABLE_PROJECTS="compiler-rt;libunwind;libcxx;libcxxabi" -DCMAKE_BUILD_TYPE=Release \
 ...
 -DLIBCXXABI_USE_LLVM_UNWINDER=ON -DLLVM_DEFAULT_TARGET_TRIPLE="x86_64-pc-linux-musl" \
 -G Ninja ../llvm
